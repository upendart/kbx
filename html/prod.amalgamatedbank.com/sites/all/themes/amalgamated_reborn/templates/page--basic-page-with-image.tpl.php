 ...
 */
?>
<!-- Basic Page with Regular Image -->
<div id="page" class="basic-page-with-image">
   ...
   <?php if (!empty($page['site_alerts'])): ?>
    ...
    <?php if (!empty($page['content_top'])): ?>
        <section class="content title with-image with-white-notch">
            <?php print render($page['content_top']); ?>
        </section>
    <?php endif; ?>

    <section class="content with-white-background">
        <div class="container">
            <div class="row r1">
